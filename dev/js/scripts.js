...
function heroAimartion(){
    var tl= gsap.timeline();
    tl.from("#first-line",{duration: 1, alpha:0, y:-100})
        .from("#second-line",{duration: 1, alpha:0, y:-70, delay:0.5})
        .from("#trails-btn",{duration: 1, alpha:0, y:50, delay:0.75})
        .from("#trails-btn i",{duration: 1, alpha:0, rotation:180, delay:0.75});

    return tl;
}

var mainTL = gsap.timeline();
mainTL.add(heroAimartion());
...
buttonAnimation.to("#trails-btn",{duration:.25, scale:heroSizeNumber},"goAway")
    .to("#trails-btn i",{duration: .25, rotateY:180})
    .to("#first-line",{duration: .25, alpha:0, y:50},"goAway")
    .to("#second-line",{duration: .25, alpha:0, y:20},"goAway");
